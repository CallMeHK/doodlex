defmodule DoodlexWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DoodlexWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DoodlexWeb.Gettext, "errors", msg, opts)
    end
  end
